...
def get_patch(img_in, img_tar, img_in2, patch_size, scale, multi_scale=False):
    ...
    # ix = random.randrange(0, iw - ip + 1) #original
    # iy = random.randrange(0, ih - ip + 1) #original
    ix = ip
    iy = ip
    ...
    # print(img_in.shape, img_tar.shape, img_in2.shape) #(32, 32, 3) (128, 128, 3) (32, 32, 3)
