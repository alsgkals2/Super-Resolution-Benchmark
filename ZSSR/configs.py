...
class Config:
    ...
    #mhkim
    # TEST_PATH = './example_with_gt'
    NAME_DATASET = 'Set14'#['Set14', 'Set5', 'Urban100', 'DIV2K', 'BSD100']
    TEST_PATH = f'/media/data1/mhkim/DS/{NAME_DATASET}/image_SRF_2'
    input_path = local_dir = TEST_PATH
    ...
    random_crop = True
    crop_size = 128 #mhkim todo change 256
...
# X2_ONE_JUMP_IDEAL_CONF.name = 'zssr_one_jump'
...
X2_IDEAL_WITH_PLOT_CONF.name='zssr_ideal_ploy'
...
X2_GRADUAL_IDEAL_CONF.name = 'zssr_gradual'
...
# Applying a given kernel. Rotations are canceled since kernel may be non-symmetric
X2_GIVEN_KERNEL_CONF = Config()
X2_GIVEN_KERNEL_CONF.name='zssr_kernel'
...
X2_GIVEN_KERNEL_CONF.input_path = '../kernel_example'
